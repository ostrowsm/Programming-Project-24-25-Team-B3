...
int buttonX = 250, buttonY = 220, visualizeButtonX = 600, visualizeButtonY = 400, buttonWidth = 100, buttonHeight = 40;
...
int returnButtonX = 600; // 可以和其他按钮保持一致或根据需要调整
int returnButtonY = 200; // 应该不同于其他按钮，避免重叠
