class Flight implements Comparable<Flight> {
    ...
    Flight(String iataCode, String flightNumber, String origin, String destination, String date, boolean cancelled, boolean diverted) {
        this.iataCode = iataCode;
        this.flightNumber = flightNumber;
        this.origin = origin;
        this.destination = destination;
        this.date = date; // Assume date is in the format "1/1/2022 12:00:00"
